...
export function seedState(): StoreState {
  ...
  const products: Product[] = [
    P({
      ...
      price: 899, compareAt: 1199, currency: "USD", billing: "once", rating: 4.8, reviews: 124, version: "2.4.1",
    ...
    P({
      ...
      price: 949, currency: "USD", billing: "once", rating: 4.9, reviews: 98, version: "3.1.0",
    ...
    P({
      ...
      price: 879, currency: "USD", billing: "once", rating: 4.7, reviews: 61, version: "1.9.2",
    ...
    P({
      ...
      price: 890, monthlyPrice: 89, yearlyPrice: 890, currency: "USD", billing: "subscription", rating: 4.9, reviews: 210, version: "5.2.0",
    ...
    P({
      ...
      price: 690, monthlyPrice: 69, yearlyPrice: 690, currency: "USD", billing: "subscription", rating: 4.7, reviews: 143, version: "4.0.3",
    ...
    P({
      ...
      price: 390, monthlyPrice: 39, yearlyPrice: 390, currency: "USD", billing: "subscription", rating: 4.6, reviews: 187, version: "6.1.4",
    ...
    P({
      ...
      price: 290, monthlyPrice: 29, yearlyPrice: 290, currency: "USD", billing: "subscription", rating: 4.5, reviews: 76, version: "2.3.0",
    ...
    P({
      ...
      price: 49, compareAt: 69, currency: "USD", billing: "once", rating: 4.8, reviews: 312, version: "3.0.0",
    ...
    P({
      ...
      price: 19, currency: "USD", billing: "once", rating: 4.9, reviews: 428, version: "2.1.0",
    ...
    P({
      ...
      price: 29, currency: "USD", billing: "once", rating: 4.6, reviews: 154, version: "1.4.0",
